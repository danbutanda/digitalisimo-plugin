...
class Digitalisimo_Content_Automation {
	...
	public static function import_image( WP_REST_Request $request ) {
		...
		require_once ABSPATH.'wp-admin/includes/file.php'; require_once ABSPATH.'wp-admin/includes/media.php'; require_once ABSPATH.'wp-admin/includes/image.php'; $title=$post_id?wp_strip_all_tags(get_the_title($post_id)):'';
