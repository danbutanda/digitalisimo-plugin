...
const modules = [
  { dir: 'digitalisimo-seo', file: 'digitalisimo-integrations.php', zip: 'digitalisimo-seo-1.0.100.zip', version: '1.0.100' },
...
if (!seoSuite.includes("digitalisimo_seo_editor_access") || !seoSuite.includes('editor_access_box') || !seoSnippetJs.includes('data-digitalisimo-open-seo-editor'))
...
if (!seoEditorialTools.includes('location_schema') || !seoSuite.includes('content_location_schema') || !seoSuite.includes("'spatialCoverage' => $area") || !seoSuite.includes("'areaServed' => $area")) throw new Error('La ubicación elegida debe emitirse como cobertura geográfica en Schema.');
