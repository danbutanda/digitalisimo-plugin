...
if (!chatbotImages.includes('#postimagediv .inside') || !chatbotImages.includes('get_post_thumbnail_id( $post_id )')) throw new Error('El generador debe vivir en Imagen destacada y confirmar su asignación.');
