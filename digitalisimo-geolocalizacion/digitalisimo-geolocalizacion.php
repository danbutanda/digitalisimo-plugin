...
define( 'DIGITALISIMO_GEOLOCATION_VERSION', '1.0.11' ); define( 'DIGITALISIMO_GEOLOCATION_FILE', __FILE__ ); define( 'DIGITALISIMO_GEOLOCATION_URL', plugin_dir_url( __FILE__ ) );
