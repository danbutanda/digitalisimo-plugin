...
| Digitalisimo IA Tools | ✓ | Perfiles por proveedor y fallback; chatbot, redacción editorial, borradores, chat de artículo, contenido, conocimiento e imágenes bajo demanda. Incluye endpoints protegidos para que Codex guarde borradores desde una keyword y el cluster elegido, sin publicar automáticamente. |
...
Última validación estructural: los ZIP de SEO 1.0.82, Ecommerce 1.0.15, Geolocalización 1.0.13, IA Tools 1.0.30 y Hosting 1.0.9 contienen su archivo principal, declaran la versión esperada y superan `unzip -t` y `tests/validate-suite.mjs`.
