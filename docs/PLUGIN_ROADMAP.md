...
| Interfaz compartida | ~ | Cada módulo tiene una sola entrada bajo Digitalisimo. SEO muestra una única barra de pestañas que incluye sus ajustes, Contenido y SEO AI; sus pantallas internas usan enlaces de regreso y no una segunda barra. AI y Chatbot abre el generador desde su pestaña Imágenes. Las operaciones especializadas se abren desde el contexto de su pestaña, sin saturar el menú lateral. Las pestañas de SEO, en sitio y en red, viven en un solo formulario: cambiar de pestaña no recarga ni pierde lo escrito, y al guardar se vuelve a la pestaña abierta. Los secretos guardados se muestran enmascarados con su estado, sin devolver el valor al navegador. Las opciones de archivo (logotipo, imagen social y la imagen social por contenido) se eligen de la biblioteca o se arrastran, sin escribir la dirección, en sitio, red y metabox. Falta comprobación visual dentro de WordPress. |
...
Última validación estructural: los ZIP de SEO 1.0.37, Ecommerce 1.0.12, Geolocalización 1.0.10, AI/Chatbot 1.0.16 y Hosting 1.0.6 contienen su archivo principal, declaran la versión esperada y superan `unzip -t`. La prueba runtime en WordPress individual/Multisite continúa pendiente.
