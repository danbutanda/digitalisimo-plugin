...
| Interfaz compartida | ~ | SEO Front valida definiciones Schema sin confundir sus referencias internas con duplicados, y el SEO publicado usa título/descripción de respaldo para social y Schema, tarjeta Twitter válida y un tipo Organization permitido. Es la última pestaña de SEO: consulta de forma anónima una URL pública del mismo sitio y muestra HTTP/redirecciones, title, metas, canonical, robots, hreflang, social, Schema, IDs duplicados y el `head` recibido; no guarda ni modifica datos. Si el servidor de WordPress no puede validar el certificado de su propio dominio, reintenta sólo esa URL propia y lo anuncia para revisar DNS, SNI o la cadena SSL desde el hosting. Contenido conserva la barra de pestañas de SEO, abre directamente su inventario de Keywords y muestra Keywords, Clusters e Intención de búsqueda como enlaces internos que cambian el panel sin recargar ni abandonar la pantalla. El inventario de keywords recorre todos los tipos de contenido públicos y consolida las fuentes Digitalisimo, Yoast y Rank Math, sin alterar datos. El submenú automático «Digitalisimo» se oculta en los cinco núcleos, mientras el menú principal conserva su panel al hacer clic. SEO AI es un submenú independiente, visible e inicializado sólo si AI y Chatbot está instalado y activo, porque usa su motor y proveedores. AI y Chatbot abre el generador desde su pestaña Imágenes. Falta comprobación visual dentro de WordPress. |
...
Última validación estructural: los ZIP de SEO 1.0.45, Ecommerce 1.0.13, Geolocalización 1.0.11, AI/Chatbot 1.0.17 y Hosting 1.0.7 contienen su archivo principal, declaran la versión esperada y superan `unzip -t`. La prueba runtime en WordPress individual/Multisite continúa pendiente.
