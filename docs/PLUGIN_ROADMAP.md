...
| Interfaz compartida | ~ | SEO Front se organiza como Resumen, Encabezados, Imágenes, Enlaces, Social y Herramientas con el detalle público equivalente a un inspector SEO. También valida definiciones Schema sin confundir sus referencias internas con duplicados, y el SEO publicado usa título/descripción de respaldo para social y Schema, tarjeta Twitter válida y un tipo Organization permitido. Es la última pestaña de SEO y no guarda ni modifica datos. Si el servidor de WordPress no puede validar el certificado de su propio dominio, reintenta sólo esa URL propia y lo anuncia para revisar DNS, SNI o la cadena SSL desde el hosting. |
...
Última validación estructural: los ZIP de SEO 1.0.47, Ecommerce 1.0.13, Geolocalización 1.0.11, AI/Chatbot 1.0.17 y Hosting 1.0.7 contienen su archivo principal, declaran la versión esperada y superan `unzip -t`. La prueba runtime en WordPress individual/Multisite continúa pendiente.
