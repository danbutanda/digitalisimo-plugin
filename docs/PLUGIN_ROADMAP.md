...
| Interfaz compartida | ~ | Cada módulo carga una superficie administrativa moderna y coherente. Las opciones de archivo (logotipo, imagen social y la imagen social por contenido) usan un campo con biblioteca de medios, arrastre y vista previa, en sitio, red y metabox. Falta comprobación visual dentro de WordPress. |
...
Última validación estructural: los ZIP de SEO 1.0.31, Ecommerce 1.0.11, Geolocalización 1.0.9, AI/Chatbot 1.0.14 y Hosting 1.0.5 contienen su archivo principal, declaran la versión esperada y superan `unzip -t`. La prueba runtime en WordPress individual/Multisite continúa pendiente.
